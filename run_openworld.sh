...
for seed in 1 2 3
do
    sh scripts/promptsrc/base2new_train.sh cifar10_ow $seed 25 base  $DEVICE
    sh scripts/promptsrc/base2new_test.sh cifar10_ow $seed 25 base  $DEVICE
    sh scripts/promptsrc/base2new_test.sh cifar10_ow $seed 25 new  $DEVICE
    sh scripts/promptsrc/base2new_test.sh cifar10_ow $seed 25 all  $DEVICE

    sh scripts/promptsrc/base2new_train.sh cifar100_ow $seed 25 base  $DEVICE
    sh scripts/promptsrc/base2new_test.sh cifar100_ow $seed 25 base  $DEVICE
    sh scripts/promptsrc/base2new_test.sh cifar100_ow $seed 25 new  $DEVICE
    sh scripts/promptsrc/base2new_test.sh cifar100_ow $seed 25 all  $DEVICE

    sh scripts/promptsrc/base2new_train.sh imagenet100 $seed 25 base  $DEVICE
    sh scripts/promptsrc/base2new_test.sh imagenet100 $seed 25 base  $DEVICE
    sh scripts/promptsrc/base2new_test.sh imagenet100 $seed 25 new  $DEVICE
    sh scripts/promptsrc/base2new_test.sh imagenet100 $seed 25 all  $DEVICE
done
